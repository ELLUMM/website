    ...
    <div className="flex min-h-screen items-center justify-center bg-background">
      <main className="flex w-7xl w-max-7xl py-35 px-6 mx-auto justify-center items-center">
        <div className="flex flex-col w-[1232px]">
            <h1 className="text-[52px] font-light mb-4 smack-in-tr" style={{ animationDelay: "300ms" }}>Get in Touch</h1>
            <h2 className="text-lg font-lignt mb-10 smack-in-tr" style={{ animationDelay: "300ms" }}>Reach out for collaborations, questions, or just to say hi. I’m always open to connect!</h2>
            <div className="flex flex-row gap-x-20">
                <div className="w-[800px]">
                    <form name="contact" method="post">
                        <div className="flex flex-col gap-1 mb-4 text-sm border-b-1 border-b-neutral-600 pop-up" style={{ animationDelay: "100ms" }}>
                            <label htmlFor="name">Name</label>
                            <input type="text" id="name" className="outline-none w-full py-3 pr-20 pl-4" placeholder="John Doe"/>
                        </div>
                        <div className="flex flex-col gap-1 mb-4 border-b-1 border-b-neutral-600 pop-up" style={{ animationDelay: "200ms" }}>
                            <label htmlFor="email">Email</label>
                            <input type="text" id="email" className="outline-none w-full py-3 pr-20 pl-4" placeholder="johndeo@example.com"/>
                        </div>
                        <div className="flex flex-col gap-1 mb-4 border-b-1 border-b-neutral-600 pop-up" style={{ animationDelay: "300ms" }}>
                            <label htmlFor="phone">Phone</label>
                            <input type="text" id="phone" className="outline-none w-full py-3 pr-20 pl-4" placeholder="Phone Number"/>
                        </div>
                        <div className="flex flex-col gap-1 mb-4 border-b-1 border-b-neutral-600 pop-up" style={{ animationDelay: "400ms" }}>
                        ...
                        <input type="submit" value="Send" className="cursor-pointer rounded-full bg-white px-8 py-2 text-base text-black smack-in-tr" style={{ animationDelay: "50ms" }}/>
                     </form>
                </div>
                <div className="flex flex-col w-[240px] gap-6 text-lg font-light pop-up" style={{ animationDelay: "300ms" }}>
                    <div>
