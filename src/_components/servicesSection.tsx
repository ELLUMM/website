...
function ServiceCard({ service }: ServiceCardProps) {
	...
	return (
		<div className="flex flex-col flex-1 basis-0 items-center p-8 border border-neutral-800 rounded-lg bg-neutral-900">
			...
			<p className="mt-2 text-center text-white/70">{service.detail}</p>
		</div>
	);
}
